...
from ultralytics.yolo.data.utils import IMG_FORMATS, VID_FORMATS, RANK, PIN_MEMORY
from ultralytics.yolo.utils import LOGGER, colorstr
from ultralytics.yolo.utils.checks import check_file
from ultralytics.yolo.utils.torch_utils import torch_distributed_zero_first
from utils.load_webcam import LoadWebcam
...
def load_inference_source(source=None, transforms=None, imgsz=640, vid_stride=1, stride=32, auto=True):
    ...
    if in_memory:
        ...
        dataset = LoadWebcam(source, imgsz=imgsz, stride=stride,auto=auto, transforms=transforms)
